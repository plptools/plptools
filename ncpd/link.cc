...
Link::Link(const char *fname, int baud, NCP *ncp, bool noDSR, unsigned short verbose, const int cancellationFd)
: ncp_(ncp)
, verbose_(verbose)
, cancellationFd_(cancellationFd) {
    ...
    dataLink_ = new DataLink(fname, baud, this, noDSR, verbose, cancellationFd);
